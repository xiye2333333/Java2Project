...
public class RepoServiceImpl implements RepoService {
    ...
    public Repo findInfo1() {
        ...
        AnalyzeReleasesAndCommits(repo, "src/main/resources/static/scikit_opt/releases.json", "src/main/resources/static/scikit_opt/commits.json");
        AnalyzeIssuesText(repo, "src/main/resources/static/scikit_opt/issues.json", "src/main/resources/static/scikit_opt/issues_comments.json", "src/main/resources/static/scikit_opt/issues_title_wordCloud.png");
        return repo;
    ...
    public Repo findInfo2() {
        ...
        AnalyzeReleasesAndCommits(repo, "src/main/resources/static/docker/releases.json", "src/main/resources/static/docker/commits.json");
        AnalyzeIssuesText(repo, "src/main/resources/static/docker/issues.json", "src/main/resources/static/docker/issues_comments.json", "src/main/resources/static/docker/issues_title_wordCloud.png");
        return repo;
    }
    ...
    private void AnalyzeIssuesText(Repo repo, String issuesFilePath, String commentsFilePath, String wordCloudFilePath) {
...
//        System.out.println(issues_body);
        ...
        repo.setComments_body_wordCloud_path(wordCloudFilePath.replace("issues_title", "comments_body"));
    ...
    private void AnalyzeReleasesAndCommits(Repo repo, String releaseFilePath, String commitFilePath) {
        ...
        for (int i = 0; i < releaseNum - 1; i++) {
            for (int j = 0; j < commitNum; j++) {
                String commitDate = commitJsonArray.getJSONObject(j).getJSONObject("commit").getJSONObject("committer").getString("date");
        ...
        for (int i = 0; i < commitNum; i++) {
            String commitDate = commitJsonArray.getJSONObject(i).getJSONObject("commit").getJSONObject("committer").getString("date");
            Date date = convertUTC(commitDate);
